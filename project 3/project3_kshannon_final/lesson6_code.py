# This is the code for all of my lesson 6 questions. Each question is seperated 
# by dashed '-' lines and Astericks '*'
...
def update_name(name, mapping):
    ...
    # YOUR CODE HERE
    street_name = re.findall(street_type_re, name)
    for key, value in mapping.iteritems():      
        if street_name[0] == key:
            print value
            print name
